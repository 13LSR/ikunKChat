export const en = {
    ...
    apiConfigDesc: 'Edit all API-related settings in JSON format. Changes are saved automatically.',
    apiConfigError: 'Invalid JSON format. Please check and try again.',
